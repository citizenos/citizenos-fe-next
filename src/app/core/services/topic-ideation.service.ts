...
export class TopicIdeationService extends ItemsListService {
  ...
  getIdeaCommentReport(data: { topicId: string; ideationId: string; ideaId: string; commentId: string; reportId: string; token: string }): Observable<any> {
  ...
  moderateIdeaComment(data: { topicId: string; ideationId: string; ideaId: string; commentId: string; reportId: string; token: string; report: any }): Observable<any> {
