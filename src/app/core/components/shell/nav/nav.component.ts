        ...
        <div class="nav_scroll">
          ...
          <div class="nav_items_wrap">
            ...
            <a class="nav_item" href="https://citizenos.com/help?app=true" target="_blank">
              <div class="icon_wrap">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <path d="M8.07 12.0775C8.25667 12.0775 8.41417 12.0133 8.5425 11.885C8.67083 11.7567 8.735 11.5992 8.735 11.4125C8.735 11.2258 8.67083 11.0683 8.5425 10.94C8.41417 10.8117 8.25667 10.7475 8.07 10.7475C7.88333 10.7475 7.72583 10.8117 7.5975 10.94C7.46917 11.0683 7.405 11.2258 7.405 11.4125C7.405 11.5992 7.46917 11.7567 7.5975 11.885C7.72583 12.0133 7.88333 12.0775 8.07 12.0775ZM8.0525 4.85C8.44917 4.85 8.77 4.95792 9.015 5.17375C9.26 5.38958 9.3825 5.66667 9.3825 6.005C9.3825 6.23833 9.3125 6.46875 9.1725 6.69625C9.0325 6.92375 8.805 7.17167 8.49 7.44C8.18667 7.70833 7.94458 7.99125 7.76375 8.28875C7.58292 8.58625 7.4925 8.8575 7.4925 9.1025C7.4925 9.23083 7.54208 9.33292 7.64125 9.40875C7.74042 9.48458 7.85417 9.5225 7.9825 9.5225C8.1225 9.5225 8.23917 9.47583 8.3325 9.3825C8.42583 9.28917 8.48417 9.1725 8.5075 9.0325C8.5425 8.79917 8.62125 8.59208 8.74375 8.41125C8.86625 8.23042 9.05583 8.035 9.3125 7.825C9.6625 7.53333 9.91625 7.24167 10.0737 6.95C10.2312 6.65833 10.31 6.33167 10.31 5.97C10.31 5.35167 10.1087 4.85583 9.70625 4.4825C9.30375 4.10917 8.77 3.9225 8.105 3.9225C7.66167 3.9225 7.25333 4.01 6.88 4.185C6.50667 4.36 6.1975 4.61667 5.9525 4.955C5.85917 5.08333 5.82125 5.21458 5.83875 5.34875C5.85625 5.48292 5.91167 5.585 6.005 5.655C6.13333 5.74833 6.27042 5.7775 6.41625 5.7425C6.56208 5.7075 6.68167 5.62583 6.775 5.4975C6.92667 5.2875 7.11042 5.12708 7.32625 5.01625C7.54208 4.90542 7.78417 4.85 8.0525 4.85ZM8 15C7.02 15 6.10417 14.8221 5.2525 14.4662C4.40083 14.1104 3.66 13.6175 3.03 12.9875C2.4 12.3575 1.90417 11.6167 1.5425 10.765C1.18083 9.91333 1 8.99167 1 8C1 7.02 1.18083 6.10417 1.5425 5.2525C1.90417 4.40083 2.4 3.66 3.03 3.03C3.66 2.4 4.40083 1.90417 5.2525 1.5425C6.10417 1.18083 7.02 1 8 1C8.96833 1 9.87833 1.18083 10.73 1.5425C11.5817 1.90417 12.3225 2.4 12.9525 3.03C13.5825 3.66 14.0812 4.40083 14.4487 5.2525C14.8162 6.10417 15 7.02 15 8C15 8.99167 14.8162 9.91333 14.4487 10.765C14.0812 11.6167 13.5825 12.3575 12.9525 12.9875C12.3225 13.6175 11.5817 14.1104 10.73 14.4662C9.87833 14.8221 8.96833 15 8 15ZM8 13.95C9.645 13.95 11.0479 13.3667 12.2088 12.2C13.3696 11.0333 13.95 9.63333 13.95 8C13.95 6.36667 13.3696 4.96667 12.2088 3.8C11.0479 2.63333 9.645 2.05 8 2.05C6.33167 2.05 4.92292 2.63333 3.77375 3.8C2.62458 4.96667 2.05 6.36667 2.05 8C2.05 9.63333 2.62458 11.0333 3.77375 12.2C4.92292 13.3667 6.33167 13.95 8 13.95Z" fill="currentColor"/>
                </svg>
                @if (helpExtraInfo()) {
            ...
            <a class="nav_item" href="https://citizenos.com/donate" target="_blank">
               <div class="icon_wrap">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <circle cx="11.8072" cy="8.0001" r="2.546" fill="currentColor" />
                  <circle cx="4.19249" cy="8.0001" r="2.546" fill="currentColor" />
                  <circle cx="8.0001" cy="4.19249" r="2.546" fill="currentColor" />
                  <circle cx="8.0001" cy="11.8077" r="2.546" fill="currentColor" />
                  <circle cx="10.6924" cy="10.6925" r="2.546" transform="rotate(45 10.6924 10.6925)" fill="currentColor" />
                  <circle cx="5.30762" cy="5.3077" r="2.546" transform="rotate(45 5.30762 5.3077)" fill="currentColor" />
                  <circle cx="10.6924" cy="5.3077" r="2.546" transform="rotate(45 10.6924 5.3077)" fill="currentColor" />
                  <circle cx="5.30762" cy="10.6925" r="2.546" transform="rotate(45 5.30762 10.6925)" fill="currentColor" />
                </svg>
              </div>
            ...
            <a class="nav_item" href="https://citizenos.com/faq" target="_blank">
              <div class="icon_wrap">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <path d="M8 1.5C4.41015 1.5 1.5 4.41015 1.5 8C1.5 11.5899 4.41015 14.5 8 14.5C11.5899 14.5 14.5 11.5899 14.5 8C14.5 4.41015 11.5899 1.5 8 1.5ZM0.5 8C0.5 3.85786 3.85786 0.5 8 0.5C12.1421 0.5 15.5 3.85786 15.5 8C15.5 12.1421 12.1421 15.5 8 15.5C3.85786 15.5 0.5 12.1421 0.5 8ZM8 11.5C8.41421 11.5 8.75 11.1642 8.75 10.75C8.75 10.3358 8.41421 10 8 10C7.58579 10 7.25 10.3358 7.25 10.75C7.25 11.1642 7.58579 11.5 8 11.5ZM8 4C6.61929 4 5.5 5.11929 5.5 6.5C5.5 6.91421 5.83579 7.25 6.25 7.25C6.66421 7.25 7 6.91421 7 6.5C7 5.94772 7.44772 5.5 8 5.5C8.55228 5.5 9 5.94772 9 6.5C9 7.05228 8.55228 7.5 8 7.5C7.58579 7.5 7.25 7.83579 7.25 8.25V9C7.25 9.41421 7.58579 9.75 8 9.75C8.41421 9.75 8.75 9.41421 8.75 9V8.25C10.0336 7.89304 10.5 6.9369 10.5 6.5C10.5 5.11929 9.38071 4 8 4Z" fill="currentColor"/>
                </svg>
              </div>
