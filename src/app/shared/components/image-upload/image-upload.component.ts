      ...
      @if (!hasImage()) {
        ...
        >
          <div class="upload-info">
            <div class="upload-title" translate="VIEWS.TOPIC_CREATE.HEADER_IMAGE_UPLOAD_DESC"></div>
            <div class="upload-desc" translate="VIEWS.TOPIC_CREATE.HEADER_IMAGE_UPLOAD_DESC_TEXT"></div>
          </div>
          <input
            #imageUpload
          ...
          <button
            ...
            (click)="triggerUpload()"
            translate="VIEWS.TOPIC_CREATE.HEADER_IMAGE_UPLOAD_BTN"
          ></button>
        </div>
      } @else {
        <div class="image-preview">
          ...
          <button class="remove-btn" (click)="removeImage()">
            ...
            <span translate="VIEWS.TOPIC_CREATE.HEADER_IMAGE_BTN_REMOVE"></span>
          </button>
        </div>
      }
