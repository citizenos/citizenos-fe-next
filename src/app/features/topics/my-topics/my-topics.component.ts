...
@Component({
          ...
          <div class="no_topics">
            ...
            <div class="no_topics_actions">
              ...
              <cos-button variant="light" [routerLink]="['/', translate.currentLang, 'topics']">
                {{ 'VIEWS.MY_TOPICS.HAVENT_ENGAGED_BTN_VIEW_PUBLIC_TOPICS' | translate }}
              </cos-button>
            </div>
          </div>
        }
  ...
  styles: [`
    ...
    .create_menu_wrapper .dropdown_menu {
      display: none;
      position: absolute;
      top: 100%;
      left: 50%;
    ...
    .create_menu_wrapper.dropdown_active .dropdown_menu {
      display: block;
    }
  `]
})
